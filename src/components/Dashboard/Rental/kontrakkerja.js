...
import "./kontrakkerja.css";
import { handleErrMsg } from "../../function/handleErrMsg"

export function KontrakKerja() {
    ...
    function handleSubmit(event) {
        ...
        axiosPrivate
            .patch("http://localhost:3001/api/penyewaan/upload/kontrakkerja/" + order_id, {
                file,
            }, {
                headers: {
            ...
            <div className="row">
                ...
                <div className="col">
                    ...
                    <div className="container-fluid g-0 p-3">
                        <h5 className="text-center"><b>Formulir Upload Kontrak Sewa</b></h5>
                        {penyewaan.map((data) => (
                            <div className="d-flex justify-content-center">
                                <form onSubmit={handleSubmit}>
                                    <div className="card p-3 mt-3 card-formulir-upload-dokumen">
                                        ...
                                        <input type="file" className="form-control" onChange={(event) => setFIle(event.target.files[0])}></input>
                                    </div>
